...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
 	const jsonLd = {
        ...
        url: `https://bokeptante.pages.dev/v/${file.filecode}`,
...
<meta itemProp="description" content={`Bokep ${file.title} di ${SITENAME} Video Bokep Indo Bocil Jepang Ngentot Jav Jilbab Smp Barat Mama Viral Sma Terbaru`} />
